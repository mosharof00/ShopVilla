...
import 'package:shop_villa/app/modules/my_order/widgets/product_labels.dart';
...
class CancelledOrder extends GetView<MyOrderController> {
  ...
  Widget _buildEmptyState() {
    return ListView( // Wrapping in a ListView to ensure RefreshIndicator can be triggered
      children: [
        Center(
          child: Column(
